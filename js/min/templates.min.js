function getNavbarTemplate(activeNav=""){return`
        <header>
            <nav class="navbar">
                <ul>
    ...
    `}function getDetailPageTemplate(siteData){return`
    ...
    `}function renderTemplate(template,container){const target=document.querySelector(container);if(target){target.innerHTML=template}}function renderPage(template){document.body.innerHTML=template;setTimeout(()=>{if(typeof updateUserNav==="function"){updateUserNav()}},100)}